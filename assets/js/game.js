...
for (var i=0; i<enemyNames.length;i++) {
    if (playerHealth > 0) {
        ...
        //if we're not at the last enemy in the array/check player health added
...
var shop = function(){
    ...
    //increase health but decrease money
    ...
    //increase attack and decrease money
        ...
        playerMoney =playerMoney - 7;
                ...
                window.alert("You don't have enough mney!");
            }
    break;
        case "LEAVE":
        case "leave":
